...
class PermissionsTabView extends StatefulWidget {
  ...
  @override
  State<PermissionsTabView> createState() => PermissionsTabViewState();
}

class PermissionsTabViewState extends State<PermissionsTabView>
  ...
  Widget _buildHorizontalTabBar(BuildContext context) {
    return TabBar(
      ...
      isScrollable: true,
      labelStyle: context.ofTheme.textTheme.titleSmall,
      tabs: _tabs
