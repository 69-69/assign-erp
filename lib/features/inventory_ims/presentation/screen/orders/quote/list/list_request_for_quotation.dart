...
class ListRequestForQuotation extends StatefulWidget {
  const ListRequestForQuotation({super.key});

  @override
  State<ListRequestForQuotation> createState() =>
      _ListRequestForQuotationState();
}

class _ListRequestForQuotationState extends State<ListRequestForQuotation> {
  ...
  Widget _buildCard(BuildContext context, List<RequestForQuotation> quotes) {
    ...
    final todayQuotations = RequestForQuotation.filterRequestForQuotationByDate(
      quotes,
    );
    final pastQuotations = RequestForQuotation.filterRequestForQuotationByDate(
      quotes,
      isSameDay: false,
    );
    ...
    return DynamicDataTable(
      ...
      childrenRow: pastQuotations.map((o) => o.itemAsList()).toList(),
