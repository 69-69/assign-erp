...
class ListStockLevel extends StatefulWidget {
  const ListStockLevel({super.key});

  @override
  State<ListStockLevel> createState() => _ListStockLevelState();
}

class _ListStockLevelState extends State<ListStockLevel> {
  final List<Product> _groupMultiDelete = [];

  /*@override
  void didUpdateWidget(ListStockLevel oldWidget) {
  ...
  Widget _buildCard(BuildContext context, List<Product> products) {
    final stockLevelProducts = Product.sortProductsByStockLevel(products);
