...
class _ListProductsState extends State<ListProducts> {
  ...
  /*@override
  void didUpdateWidget(ListProducts oldWidget) {
  ...
  Widget _buildCard(BuildContext context, List<Product> products) {
    final inStockProducts = Product.filterProductsByStock(products);
    final outOfStockProducts = Product.filterProductsByStock(
      products,
      inStock: false,
    );
